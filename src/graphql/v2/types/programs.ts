...
export const ProgramV2Type: ReturnType<typeof ProgramV2Ref.implement> =
  ProgramV2Ref.implement({
    fields: (t) => ({
      id: t.exposeID("id"),
      ...
      applicationCount: t.field({
        ...
        resolve: (program) => {
          ...
          return (
            (program as DBProgramV2 & { applicationCount?: number })
              .applicationCount ?? 0
          );
        },
      }),
