...
CREATE TYPE "public"."milestone_status_v2" AS ENUM('draft', 'under_review', 'in_progress', 'completed', 'update');--> statement-breakpoint
...
CREATE TABLE "applications_v2" (
	...
	"status" "application_status_v2" DEFAULT 'submitted' NOT NULL,
	"title" text DEFAULT '',
	"content" text DEFAULT '',
	"rejected_reason" text DEFAULT '',
	"picked" boolean DEFAULT false NOT NULL,
	"chatroom_message_id" uuid,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
	CONSTRAINT "applications_v2_chatroom_message_id_unique" UNIQUE("chatroom_message_id")
);
...
CREATE TABLE "users_v2" (
	"id" serial PRIMARY KEY NOT NULL,
	"role" "user_roles_v2" DEFAULT 'user' NOT NULL,
...
ALTER TABLE "milestones_v2" ADD CONSTRAINT "milestones_v2_application_id_applications_v2_id_fk" FOREIGN KEY ("application_id") REFERENCES "public"."applications_v2"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "onchain_program_info" ADD CONSTRAINT "onchain_program_info_network_id_networks_id_fk" FOREIGN KEY ("network_id") REFERENCES "public"."networks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "smart_contracts" ADD CONSTRAINT "smart_contracts_chain_info_id_networks_id_fk" FOREIGN KEY ("chain_info_id") REFERENCES "public"."networks"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "contracts" ADD CONSTRAINT "contracts_application_id_applications_v2_id_fk" FOREIGN KEY ("application_id") REFERENCES "public"."applications_v2"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
