 ...
 * 7. Sponsor creates onchain contract info
 */
describe('E2E Contract Scenario Test', () => {
  ...
  it('should complete the full contract scenario', async () => {
    // ==========================================
    // Step 1: Sponsor creates a program
    // ==========================================
    console.log('📝 Step 1: Sponsor creates a program');
    ...
    programId = Number.parseInt(createProgramResult.data.createProgramV2.id, 10);
    ...
    // ==========================================
    // Step 7: Sponsor creates onchain contract info with deposit
    // ==========================================
    console.log('📝 Step 7: Sponsor creates onchain contract info');
